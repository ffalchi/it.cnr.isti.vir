...
public class FloatsL1Metric  implements IMetric<Floats>, IMeanEvaluator<Floats> {
	...
	public FloatsL1Metric(Properties properties) {
		
	}
	
	public FloatsL1Metric() {
	...
	public final double distance(Floats f1, Floats f2, double max) {
		return L1.get(f1.getValues(), f2.getValues(), max );
	}
